(function () {
  ...
  const translations = {
    zh: {
      ...
      officialPluginsHint: "官方目录可直接通过 Git 同步；安装插件需要 Claude CLI。组织后台的插件列表仍由 Claude 账号或组织策略决定。",
      ...
      verificationDirect3p: "已确认：Claude Desktop 已启动，直连 3P 配置已应用",
    ...
    en: {
      ...
      officialPluginsHint: "The official directory can sync directly through Git. Installing plugins requires Claude CLI. Organization-provided plugin lists remain controlled by account or organization policy.",
      ...
      verificationDirect3p: "Confirmed: Claude Desktop started with direct 3P config applied",
